 ...
 * 
 * <p>
 * A list of all expire dates/times can be found at the
...
public enum PasteExpireDate {
	NEVER("N", -1), TEN_MINUTES("10M", 10 * 60), ONE_HOUR("1H", 60 * 60), ONE_DAY("1D", 60 * 60 * 24),
	ONE_WEEK("1W", 60 * 60 * 24 * 7), TWO_WEEKS("2W", 60 * 60 * 24 * 14), ONE_MONTH("1M", -1);
